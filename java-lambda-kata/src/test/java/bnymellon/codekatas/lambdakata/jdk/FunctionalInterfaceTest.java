...
public class FunctionalInterfaceTest
{
    ...
    public void consumer()
    {
        ...
        var consumer = (Consumer<String>) s -> result.add(s.toUpperCase());
    ...
    public void predicateIsEven()
    {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        var evenPredicate = (Predicate<Integer>) i -> i % 2 == 0;
    ...
    public void predicateIsOdd()
    {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        var oddPredicate = (Predicate<Integer>) i -> i % 2 ==1;
    ...
    public void function()
    {
        ...
        var toUppercase = (Function<String, String>) String::toUpperCase;
    ...
    public void supplier()
    {
        ...
        var supplier = (Supplier<List<String>>) CopyOnWriteArrayList::new;
    ...
    public void biConsumer()
    {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        var biConsumer = (BiConsumer<String, String>) (key, value) -> result.put(key.toUpperCase(), value.toUpperCase());
    ...
    {
        // TODO - Convert the anonymous inner class to a lambda
        var squared = (UnaryOperator<Integer>) i -> i * i;
