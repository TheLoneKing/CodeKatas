...
public class EclipseCollectionsFunctionalInterfaceTest
{
    ...
    public void procedure()
    {
        ...
        var procedure = (Procedure<String>) each -> result.add(each.toUpperCase());
    ...
    public void function0()
    {
        ...
        var supplier = (Function0<List<String>>) FastList::newList;
    ...
    public void procedure2()
    {
        ...
        // TODO - Convert the anonymous inner class to a lambda
        var procedure2 = (Procedure2<String, String>) (key, value) -> result.put(key.toUpperCase(), value.toUpperCase());
